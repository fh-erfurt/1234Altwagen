...
class EmployeeTest {
    ...
    void locationShouldBeChanged() throws CarCountBelowZeroException {
        Employee employee = userManager.registerEmployee("Maxi", "Mustermann", "mm@fh-erfurt.de", "1234a", "Deutschland", "Erfurt", "99087", "Altonaer Straße", "1");
        Car car = carManager.addNewCar("z1a2b3c4d","2000", 123, "Tesla", "Testmodel","Note",locationManager.addLocation("germany","Erfurt", "99086", "LeuneburgUfer", "2","Test",5, 2),NOT_READY_FOR_SALE);
        Location location = locationManager.addLocation("england","London", "99086", "LeuneburgUfer", "2","Test",5, 2);
    ...
    void requestShouldBeDenied() {
        ...
        assertEquals(request.getStatus(),1,"Request status should be denied");
